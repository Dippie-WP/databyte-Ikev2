<#
.SYNOPSIS
    Databyte VPN installer (Windows template) for Windows 10/11.
...
.DESCRIPTION
    Customer-facing one-liner:
        curl.exe -ksSL https://vpn-portal.databyte.co.za/static/baked/setup-databyte-vpn-windows.ps1 | powershell -ExecutionPolicy Bypass -NoProfile -
...
.NOTES
    File:           setup-databyte-vpn-windows.ps1
    Version:        1.0.0
    ...
    OPERATOR WORKFLOW:
      ...
      3. Save as: setup-databyte-vpn-windows.ps1
