...
roadmap = [
    ...
    ("5D",  "RADIUS migration",      "FreeRADIUS + daloRADIUS, single MariaDB, portal keeps management. Direct-to-prod, nuke + start fresh (per Zun #23766 + #23783).", "✅ Phase 5 LIVE 2026-07-06 — cut test verified; 40 customers LOCKED OUT (re-register via Phase 6)", "Phases 1-4 ✅ done, Phase 5 ✅ live, Phase 6 pending (re-register), Phase 7 pending (cleanup)"),
